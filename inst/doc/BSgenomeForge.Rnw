...
\item \code{seqfiles\_prefix}, \code{seqfiles\_suffix}: [OPTIONAL] Default value
      for \code{seqfiles\_suffix} is \code{.fa}.

\item \code{AGAPSfiles\_type}, \code{AGAPSfiles\_name}, \code{AGAPSfiles\_prefix},
      \code{AGAPSfiles\_suffix}: [OPTIONAL]
\end{itemize}
