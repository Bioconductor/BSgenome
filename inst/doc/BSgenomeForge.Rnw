...
% The error is hard to reproduce. I've observed it on this vignette and with the
% following version of the MiKTeX/pdflatex command:
%   MiKTeX-pdfTeX 2.7.3147 (1.40.9) (MiKTeX 2.7)
% Until this problem is fixed, I'm commenting out the use of hyperref and
% redefining the \url command.
%\usepackage{hyperref}
