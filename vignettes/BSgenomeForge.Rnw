...
<<eval=false>>=
library(BSgenome)
#forgeBSgenomeDataPkg("path/to/my/seed", ondisk_seq_format="fa.rz")  # not ready yet
forgeBSgenomeDataPkg("path/to/my/seed", ondisk_seq_format="rda")
@
...
The \code{ondisk\_seq\_format} argument was added in Bioconductor 2.14 and
can be either \code{"rda"}, \code{"fa"}, or \code{"fa.rz"}.
See \code{?forgeBSgenomeDataPkg} for the details.
%Starting with Bioconductor 2.14, \code{"fa.rz"} is the recommended format.
