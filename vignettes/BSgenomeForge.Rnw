...
<<eval=false>>=
library(BSgenome)
#forgeBSgenomeDataPkg("path/to/my/seed", storage.mode="fa.rz")  # not ready yet
forgeBSgenomeDataPkg("path/to/my/seed", storage.mode="rda")
@
...
The \code{storage.mode} argument was added in Bioconductor 2.14 and can be
either \code{"rda"}, \code{"fa"}, or \code{"fa.rz"}.
