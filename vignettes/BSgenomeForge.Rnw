...
<<eval=false>>=
library(BSgenome)
forgeBSgenomeDataPkg("path/to/my/seed", ondisk_seq_format="2bit")
@
...
The \code{ondisk\_seq\_format} argument can be either \code{"2bit"},
\code{"rda"}, \code{"fa.rz"}, or \code{"fa"}. See \code{?forgeBSgenomeDataPkg}
for the details.
