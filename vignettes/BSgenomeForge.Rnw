...
data package} that we want to forge.
...
<<eval=false>>=
library(BSgenome)
forgeBSgenomeDataPkg("path/to/my/seed", mode="fa.rz")
@
...
\code{"rda"} or \code{"fa.rz"}. See \code{?forgeBSgenomeDataPkg} for the
details. Starting with Bioconductor 2.14, \code{"fa.rz"} is the recommended
mode.
